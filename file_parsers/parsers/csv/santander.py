...
class SantanderCSVParser(BankCSVParsers):
    """CSV Parser for Santander bank statements.

    This class extends BankCSVParsers and provides a specific implementation for parsing
    Santander bank statements in CSV format.
    """

    def parse_csv(self, csv_path: str, user: User) -> Tuple[List[Income], List[Expense]]:
        """Parse a Santander bank statement in CSV format and import the transactions as
        ...
        with open(csv_path, "r", encoding="utf-8") as csv_file:
            ...
            for line_number, row in enumerate(csv_reader, start=1):
                ...
                try:
                    ...
                    print(f"Error: Currency with code '{currency_code}' does not exist. Skipping line {line_number}")
                    continue
